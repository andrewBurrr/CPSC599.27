...
for epoch in range(20):
    ...
    # Evaluate the model on the eval set after each epoch
    model.eval()
    with torch.no_grad():
        eval_loss = 0.0
        eval_correct = 0
        ...
        print(f'Epoch {epoch + 1}, Dev Loss: {eval_loss:.3f}, Dev Accuracy: {eval_accuracy:.3f}')

    model.train()

model.save_pretrained("./models/xlm-roberta-gk-en")